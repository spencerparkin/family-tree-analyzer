...
class SearchResults(object):
    ...
    def generate_png_file(self, out_file, root_person):
        ...
        person_subset = person_subset.union({relationship.person for relationship in self.no_baptism_list})
        person_subset = person_subset.union({relationship.person for relationship in self.no_endownment_list})
        person_subset = person_subset.union({relationship.person for relationship in self.no_sealing_to_parents_list})
        person_subset = person_subset.union({relationship.person for relationship in self.no_sealing_to_spouse_list})
